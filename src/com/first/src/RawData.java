...
public class RawData extends javax.swing.JFrame {
    ...
    public RawData(List<Packet> p, int index, PcapHandle handle) {
        ...
        ha = handle;
        initComponents();
        jTextArea1.setText(Arrays.toString(p.get(index).getRawData()));
    }
    ...
    private void initComponents() {
        ...
        JLabel headerLabel = new JLabel("RAW DATA DETAILS", SwingConstants.CENTER);
        ...
        jTextArea1.setFont(new Font("Monospaced", Font.PLAIN, 14)); // Monospaced for better readability
        JScrollPane scrollPane = new JScrollPane(jTextArea1);
        scrollPane.setBorder(BorderFactory.createTitledBorder("Raw Data Content"));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            ...
            new RawData(new ArrayList<>(), 0, null).setVisible(true);
        });
    }
}